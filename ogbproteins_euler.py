...
class HNO(torch.nn.Module):
    ...
    def __init__(self,hidden_channels):
        ...
        self.lin= nn.Linear(data.x.size(-1), hidden_channels)

        # self.conv1 = ChebConv(data.x.size(-1), hidden_channels,K=2
        self.conv1 = Euler_ChebConv(hidden_channels, hidden_channels,K=K,step_size=step_size,dissipation_force=dissipation_force)
        self.conv2 = Euler_ChebConv(hidden_channels, hidden_channels,K=K,step_size=step_size,dissipation_force=dissipation_force)
        self.conv3 = Euler_ChebConv(hidden_channels, hidden_channels,K=K,step_size=step_size,dissipation_force=dissipation_force)
        self.conv4 = Euler_ChebConv(hidden_channels, hidden_channels,K=K,step_size=step_size,dissipation_force=dissipation_force)
...
name="DeepEulerCheb_step_"+str(step_size),
)
