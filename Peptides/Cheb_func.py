...
# Load JSON config
with open('config_cheb.json', 'r') as f:   #### Change path accordingly
    config = json.load(f)
...
model = HNO(num_feats,args.hidden,args.K,args.num_layers,args.mlp_layers,num_classes).to(device)
